"""
================================================================================
 Deep RL Course · Chapter 8 · 从零手写 PPO（学习笔记描述）
================================================================================
 一句话：PPO 是最常用的策略优化算法——用"裁剪(clip)"限制每步更新幅度，稳定又好用。
 本章讲：
   ① Actor-Critic 结构 + 优势估计(GAE)。
   ② PPO 裁剪目标：限制新旧策略比值,防更新过猛崩掉。
   ③ 从零实现训练循环(对照 LLM 里的 GRPO/PPO,见 Ch12)。
 要点：裁剪目标是 PPO 的灵魂；和 RLHF 的 PPO 同源。
 说明：notebook 摘录，需 torch/gym[box2d]；参考为主。
================================================================================
"""
