...
def setup_logging(debug=False):
    h=logging.StreamHandler(sys.stdout);h.setFormatter(JsonFormatter());root=logging.getLogger();root.handlers[:]=[h];root.setLevel(logging.DEBUG if debug else logging.INFO)
