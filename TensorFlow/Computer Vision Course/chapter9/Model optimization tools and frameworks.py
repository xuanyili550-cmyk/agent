"""
================================================================================
 CV Course · Chapter 9 · 模型优化工具与框架（学习笔记描述）
================================================================================
 一句话：把训好的视觉模型压小压快好部署——量化、剪枝、蒸馏 + 各家工具。
 本章讲：
   ① TensorFlow Model Optimization Toolkit：训练后量化(8bit,约缩小4×)、剪枝。
   ② 量化/剪枝的收益(体积↓延迟↓)与代价(精度略降)。
   ③ 边缘设备部署与硬件加速。
 要点：部署优化的通用手段与 LLM 那套一致(量化/剪枝/蒸馏)。
 说明：工具指引为主，需对应框架；参考为主。
================================================================================
"""
